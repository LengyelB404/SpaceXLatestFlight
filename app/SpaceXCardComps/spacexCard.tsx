...
export default function SpaceXCard(){
    ...
    if (dataInfo) {
      ...
      return (
        <div className="bg-slate-600 rounded w-min p-3 font-[family-name:var(--font-geist-sans)]">
          <h1 className="font-bold text-2xl bg-slate-500 p-2 rounded">{dataInfo.flight_number}</h1>
          <p>{}</p>
        </div>
      )  
    }else{
